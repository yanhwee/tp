...
import seedu.address.logic.autocomplete.field.ProcurementDateField;
...
public class ProcurementDateFieldParser implements FieldParser {
    @Override
    public Optional<Field> parse(TextWithCursor text) {
        return Optional.of(new ProcurementDateField(text));
    }
}
